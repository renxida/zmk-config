# renxida's zmk-config

This is my personal [ZMK firmware](https://github.com/zmkfirmware/zmk/) configuration, made based on [urob's original work.](https://github.com/urob/zmk-config)
...
## Highlights
From renxida:
- lily58 (needed to add an extra row to make it work)
- cradio (needed to add some empty macros to make it work)
- a combo hotkey for ctrl+shift+printscreen 
